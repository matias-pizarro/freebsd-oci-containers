...
echo
echo "node:24-freebsd15.snapshot"
podman tag localhost/node:24-freebsd15.snapshot "${IMAGE_PATH}"/node:24-freebsd15.snapshot
podman push "${IMAGE_PATH}"/node:24-freebsd15.snapshot
