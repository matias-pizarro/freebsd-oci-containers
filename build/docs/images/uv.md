...
=== "Image"
    ...
    ```dockerfile title="images/14.3/uv/3.11/Containerfile"
    --8<-- "images/14.3/uv/3.11/Containerfile"
    ```

    ## Build the image

    ```console title="images/14.3/uv/3.11/build.sh"
    --8<-- "images/14.3/uv/3.11/build.sh:6"
    ```

    ## Test the image

    ```console title="images/14.3/uv/3.11/test.sh"
    --8<-- "images/14.3/uv/3.11/test.sh:6"
    ```

    ## Push the image

    ```console title="images/14.3/uv/3.11/push.sh"
    --8<-- "images/14.3/uv/3.11/push.sh:6"
    ```

    ## Run the full pipeline from building to pushing

    ```console title="images/14.3/uv/3.11/run_pipeline.sh"
    --8<-- "images/14.3/uv/3.11/run_pipeline.sh:6"
    ```
